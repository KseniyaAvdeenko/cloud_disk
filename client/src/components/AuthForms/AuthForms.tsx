...
const AuthForms = () => {
    ...
    const onChangeSignIn = (e: ChangeEvent<HTMLInputElement>) => setSignInUser({...sInUser, [e.target.name]: e.target.value})
    const onChangeSignUp = (e: ChangeEvent<HTMLInputElement>) => setSignUpUser({...sUpUser, [e.target.name]: e.target.value})
